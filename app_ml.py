...
def run_ml_app() :
    ...
    # 자산은 20만 달라이면, 이 사람은 얼마짜리 차를 살것인가?
    ...
    salary = st.number_input('연봉 입력', 1000, 100000000)
    
    debt = st.number_input('카드빚 입력', 0 , 10000000)
    
    worth = st.number_input('자산 입력', 100, 10000000)
    ...
    if y_pred < 0 :
        ...
        st.info('예측한 자동차 금액은 {}달러 입니다.'.format(y_pred[0]))
